Vue.component('contact_form_1722226699', {
  template: `
    <main class="flex justify-center align-center p-10">
      <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
        <div>
          <h3 class="text-black font-semibold text-xl">Get in Touch with the Builders</h3>
          <p class="mt-3 text-black w-fit">Let's discuss how we can help bring your construction projects to life.</p>
        </div>
